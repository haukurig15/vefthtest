...
namespace CoursesAPI.Tests.Services
{
    ...
    public class CourseServicesTests
	{
		...
		[TestMethod]
		public void GetCoursesBySemester_ReturnsListOfCourses()
		{
			// Arrange:
				
			// Act:
			var semester20163 = _service.GetCourseInstancesBySemester("20163");
			var semester20153 = _service.GetCourseInstancesBySemester("20153");

			// Assert:
			Assert.AreEqual(semester20163.Count(),2);
			Assert.AreEqual(semester20153.Count(),1);
		}

		[TestMethod]
		public void GetCoursesBySemester_NoSemesterDefined()
		{
			// Arrange:

			// Act:
			var noSemesterSelected = _service.GetCourseInstancesBySemester();

			// Assert:
			Assert.AreEqual(noSemesterSelected.Count(),1);
		}

		[TestMethod]
		public void GetCoursesBySemester_NameOfTeacherIncluded()
		{
			// Arrange:
			
			// Act:
			var teacherName = _service.GetCourseInstancesBySemester("20153");

			// Assert:
			Assert.AreEqual(teacherName[0].MainTeacher, "Daníel B. Sigurgeirsson");
			Assert.AreNotEqual(teacherName[0].MainTeacher,"Jón Jónsson");
		}

		[TestMethod]
		public void GetCoursesBySemester_MainTeacherNotDefined()
		{
			// Arrange:
			
			// Act:
			var teacherName2 = _service.GetCourseInstancesBySemester("20163");

			// Assert:
			Assert.AreEqual(teacherName2[0].MainTeacher,"");
			Assert.AreEqual(teacherName2[1].MainTeacher,"");
		}
